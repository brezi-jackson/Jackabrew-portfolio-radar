# Brezi iOS App — Iteration 4, Round 1 Design Spec
**Author:** Picasso (Design) | March 20, 2026
**Status:** Complete spec for engineering handoff
...
**Past-window state:** If current time > cutoff, button changes:
- Background: `#333333`
- Text: "BREW ANYWAY"
- Subtext below button: "Past your window. Still your call." — `t_caption`, `#888888`
...
| Ring progress | Fills over 12 minutes (default steep time for profile) |
...
- At recommended steep time (e.g. 12:00 for First Light), ring completes + subtle pulse
...
│ │  🌙 Sleep-safe by 11:14 PM           │ │  ← tertiary, static
│ │                                      │ │
│ │  ┌──────────────────────────────┐    │ │
│ │  │▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░░░░░ │    │ │  ← caffeine decay bar
│ │  │ ~120mg              → 0mg   │    │ │
...
**Time calculations:**
- Peak time: `brew_end + 45min`
- Half-life: `brew_end + 5h`
- Sleep-safe: `brew_end + 10h` (approx 3 half-lives, ~12.5% remaining — conservative)
...
**Connect buttons:** Initiate OAuth flow for respective wearable. On success → green checkmark replaces button text. On failure → "Connection failed. Try again." inline error.
...
| Label | 20px bold, `#FFFFFF` |
| Sublabel | 14px regular, `#888888` |
...
| Appears after | 5+ brews with check-in data |
...
| `brew_cta_past_sub` | "Past your window. Still your call." |
...
*Spec written March 20, 2026. Locked against Iteration 4 architecture. Every string is paste-ready. Every component is spec'd to pixel. Every animation has timing values. Ship it.*
