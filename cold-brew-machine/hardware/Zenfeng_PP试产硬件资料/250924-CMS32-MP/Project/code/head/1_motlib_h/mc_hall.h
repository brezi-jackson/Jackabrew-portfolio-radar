...
//extern const signed int HALL_AD_Value[8];

extern signed int         HALL_Angle_CW[8][2];
extern signed int         HALL_Angle_CCW[8][2];
extern signed int         HALL_AD_Value[8];
...
void 	FOC_HallAngle_Calc(struct_Hall *p);
