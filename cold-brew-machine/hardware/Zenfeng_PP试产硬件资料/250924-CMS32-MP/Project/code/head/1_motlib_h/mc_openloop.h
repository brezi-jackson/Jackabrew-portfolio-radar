...
#define	   START_REVUP_CURRENT1								(2000)			// 阶段1 电流 单位：Q15
#define	   START_REVUP_CURRENT2								(3000)			// 阶段2 电流 单位：Q15
#define	   START_REVUP_CURRENT3								(4000)			// 阶段3 电流 单位：Q15

#define	   START_REVUP_WE_K1								  (100)				// 阶段1 速度斜率 每WE_K1周期角度增量加1
#define	   START_REVUP_WE_K2								  (120)				// 阶段2 速度斜率 每WE_K2周期角度增量加1
#define	   START_REVUP_WE_K3								  (140)				// 阶段3 速度斜率 每WE_K3周期角度增量加1

#define	   START_REVUP_WEMIN								  (1)					// 开环最小We
#define	   START_REVUP_WEMAX								  (60)				// 开环最大We
